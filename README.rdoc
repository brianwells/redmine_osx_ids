...
1. Choose Administration > Settings > Authentication > External Authentication
...
1. Choose Administration > Settings > Groups > New group
...
If on-the-fly user creation was enabled, the users will be created automatically when they first log in. However, even then there may be a need to create the user account in advance.

1. Choose Administration > Settings > Users > New user
